...
public class MiniGameAnswerPoint : VisualElement, INotifyValueChanged<float>
{
    ...
    public new class UxmlFactory : UxmlFactory<MiniGameAnswerPoint, UxmlTraits> { }
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        {
            base.Init(ve, bag, cc);
            var ate = ve as MiniGameAnswerPoint;
    ...
    public MiniGameAnswerPoint() : base()
    {
